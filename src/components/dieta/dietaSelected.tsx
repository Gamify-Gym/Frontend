        ...
        <View style={styles.chartSection}>
            ...
            <Svg width={200} height={200}>
              <G rotation="-90" origin="100, 100">
                ...
                <Circle
                  ...
                  strokeDashoffset={
                    -(
                      (dailyTotals.fats + dailyTotals.carbs) /
                      (dailyTotals.proteins +
                        dailyTotals.carbs +
                        dailyTotals.fats)
                    ) * 534
          ...
          <View style={styles.chartLegend}>
            <View style={styles.chartLegendItem}>
              <View
                style={[styles.chartLegendDot, { backgroundColor: "#ff6b9d" }]}
              />
              <Text style={styles.chartLegendText}>Proteínas</Text>
              <Text style={styles.chartLegendValue}>
                {Math.round(dailyTotals.proteins)}g
              </Text>
            ...
            <View style={styles.chartLegendItem}>
              <View
                style={[styles.chartLegendDot, { backgroundColor: "#ffa64d" }]}
              />
            ...
            <View style={styles.chartLegendItem}>
              <View
                style={[styles.chartLegendDot, { backgroundColor: "#4dabff" }]}
              />
...
const styles = StyleSheet.create({
  container: { width: "92%", alignSelf: "center", marginBottom: 20 },
  header: {
    marginBottom: 20,
    alignItems: "center",
  ...
  chartLabel: { fontSize: 13, color: "#9f7dcc", fontWeight: "600" },
  chartLegend: { width: "100%", gap: 10 },
  chartLegendItem: {
    flexDirection: "row",
    alignItems: "center",
    gap: 10,
  ...
  chartLegendDot: { width: 14, height: 14, borderRadius: 7 },
  chartLegendText: {
    fontSize: 14,
    fontWeight: "600",
    color: "#ffffff",
  ...
  mealTime: { fontSize: 12, color: "#c5a8e0", fontWeight: "500" },
  mealItemCount: { fontSize: 11, color: "#9f7dcc", fontWeight: "500" },
  addButton: {
    width: 44,
    height: 44,
    borderRadius: 22,
  ...
  miniStatText: { fontSize: 12, fontWeight: "600", color: "#e5d4f0" },
  miniStatDivider: {
    width: 1,
    height: 14,
  ...
  expandedStatItem: { alignItems: "center", gap: 6 },
  expandedStatInfo: { alignItems: "center" },
  expandedStatValue: { fontSize: 16, fontWeight: "700", color: "#ffffff" },
  expandedStatLabel: { fontSize: 10, color: "#9f7dcc", fontWeight: "500" },
  expandedStatDivider: {
    width: 1.5,
    height: 40,
    backgroundColor: "rgba(169, 112, 255, 0.3)",
  },
  alimentosListContainer: { gap: 10 },
  emptyMealState: {
    alignItems: "center",
    justifyContent: "center",
    paddingVertical: 40,
  ...
  emptyMealText: { fontSize: 15, fontWeight: "600", color: "#c5a8e0" },
  emptyMealSubtext: { fontSize: 12, color: "#9f7dcc" },
  alimentoCard: {
  ...
  alimentoCardContent: { padding: 14 },
  alimentoHeader: {
    flexDirection: "row",
    justifyContent: "space-between",
  ...
  alimentoName: { fontSize: 15, fontWeight: "700", color: "#2a1a45", flex: 1 },
  caloriesBadge: {
  ...
  proteinValue: { color: "#ff6b9d" },
  carbsValue: { color: "#ffa64d" },
  fatsValue: { color: "#4dabff" },
  fibersValue: { color: "#8b5fbf" },
});
